...
type NativeProduct={id:string;slug:string;name:string;country?:string;city?:string;duration_label?:string;tag?:string;included?:string[];image_url?:string;images?:NativeImage[];from_price_amount?:number;active_departure_count?:number;departures?:NativeDeparture[]};
