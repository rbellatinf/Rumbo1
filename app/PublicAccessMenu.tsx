...
import { Building2, ChevronDown, CircleUserRound, ShieldCheck, UsersRound } from "lucide-react";
...
export default function PublicAccessMenu(){
  ...
  return createPortal(<div ref={wrap} style={{position:"relative",zIndex:70,transform:"translateX(-215px)"}}><button type="button" onClick={()=>setOpen(v=>!v)} aria-expanded={open} aria-haspopup="menu" style={{height:46,display:"flex",alignItems:"center",gap:8,padding:"0 15px",border:"1px solid rgba(255,255,255,.38)",borderRadius:999,background:"rgba(255,255,255,.96)",color:"#10223f",fontWeight:800,fontSize:14,cursor:"pointer",boxShadow:"0 8px 24px rgba(16,34,63,.12)"}}><CircleUserRound size={19}/><span>Iniciar sesión</span><ChevronDown size={15}/></button>{open?<div role="menu" style={{position:"absolute",right:0,top:"calc(100% + 9px)",width:280,padding:8,border:"1px solid #e4e7ec",borderRadius:15,background:"white",boxShadow:"0 18px 50px rgba(16,34,63,.2)",color:"#10223f"}}><a href="/acceso/partner" role="menuitem" onClick={()=>setOpen(false)} style={{display:"flex",gap:11,alignItems:"center",padding:"12px 11px",borderRadius:10,color:"#10223f",textDecoration:"none"}}><span style={{width:38,height:38,display:"grid",placeItems:"center",borderRadius:10,background:"#fff1ed",color:"#e9573b"}}><UsersRound size={19}/></span><span><strong style={{display:"block",fontSize:14}}>Soy Partner</strong><small style={{display:"block",marginTop:2,color:"#667085"}}>Ventas, afiliados y comisiones</small></span></a><a href="/acceso/minorista" role="menuitem" onClick={()=>setOpen(false)} style={{display:"flex",gap:11,alignItems:"center",padding:"12px 11px",borderRadius:10,color:"#10223f",textDecoration:"none"}}><span style={{width:38,height:38,display:"grid",placeItems:"center",borderRadius:10,background:"#eef4f8",color:"#31566f"}}><Building2 size={19}/></span><span><strong style={{display:"block",fontSize:14}}>Soy Agencia</strong><small style={{display:"block",marginTop:2,color:"#667085"}}>Administrador o Counter minorista</small></span></a><div style={{height:1,background:"#eef0f3",margin:"5px 4px"}}/><a href="/admin/acceso" role="menuitem" onClick={()=>setOpen(false)} style={{display:"flex",gap:11,alignItems:"center",padding:"12px 11px",borderRadius:10,color:"#10223f",textDecoration:"none"}}><span style={{width:38,height:38,display:"grid",placeItems:"center",borderRadius:10,background:"#eaf0f8",color:"#102b50"}}><ShieldCheck size={19}/></span><span><strong style={{display:"block",fontSize:14}}>Admin Rumbo</strong><small style={{display:"block",marginTop:2,color:"#667085"}}>Backoffice mayorista e interno</small></span></a></div>:null}</div>,host);
}
