...
export default function AdminLayoutClient({children}:{children:ReactNode}){
  ...
  useEffect(()=>{
    ...
    const check=()=>{
      ...
      if(sidebar&&content)setAdminReady(true);
    };
    check();
  ...
  function closeModal(){setModal(null);setError("");setCredentials(null);setDetail(null);setSelectedAgency(null)}
